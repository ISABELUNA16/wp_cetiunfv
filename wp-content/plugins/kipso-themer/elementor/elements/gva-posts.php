...
class GVAElement_Posts extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Posts', 'kipso-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'post-style-1'         => __( 'Item Post Style I', 'kipso-themer' ),
                    'post-style-2'         => __( 'Item Post Style II', 'kipso-themer' )
                ],
                'condition' => [
        ...
        $this->add_control(
            'image_size',
            [
               'label'     => __('Image Style', 'kipso-themer'),
               'type'      => \Elementor\Controls_Manager::SELECT,
