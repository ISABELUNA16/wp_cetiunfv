...
class GVAElement_Socials extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Socials', 'kipso-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'socials',
            [
                'label'       => __('Social Icon Item', 'kipso-themer'),
                ...
                'fields'      => [
                    ...
                    [
                        'name'       => 'social_icon',
                        'label'      => __('Choose Icon', 'kipso-themer'),
                        'type'       => 'icon',
                        'show_label' => false,
                    ],
                    [
                        'name'    => 'social_link',
                        'label'   => __('Social Link', 'kipso-themer'),
                        'default' => 'John Doe',
                        'type'    => Controls_Manager::TEXT,
                    ],
                    [
                        'name'      => 'social_color',
                        'label'     => __('Social Color', 'kipso-themer'),
                ...
                'default'     => array(
                    array(
                        'social_title'      => esc_html__( 'Facebook', 'kipso-themer' ),
                        'social_icon'       => esc_html__( 'fa fa-facebook', 'kipso-themer' ),
                        'social_link'       => '#',
                    ),
                    array(
                        'social_title'      => esc_html__( 'Twitter', 'kipso-themer' ),
                        'social_icon'       => esc_html__( 'fa fa-twitter', 'kipso-themer' ),
                        'social_link'       => '#',
                    ),
                    array(
                        'social_title'      => esc_html__( 'Instagram', 'kipso-themer' ),
                        'social_icon'       => esc_html__( 'fa fa-instagram', 'kipso-themer' ),
                        'social_link'       => '#',
                    ),
                    array(
                        'social_title'      => esc_html__( 'pinterest', 'kipso-themer' ),
                        'social_icon'       => esc_html__( 'fa fa-pinterest', 'kipso-themer' ),
                        'social_link'       => '#',
                    ),
                ),
            ]
