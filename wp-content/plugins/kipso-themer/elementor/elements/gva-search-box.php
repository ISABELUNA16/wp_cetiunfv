...
class GVAElement_Search_Box extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Search Box', 'kipso-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'fa fa-search', 'kipso-themer' ),
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => __( 'Icon Size', 'kipso-themer' ),
		...
		$this->add_control(
			'icon_background',
			[
				'label' => __( 'Background', 'kipso-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Hover', 'kipso-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_responsive_control(
			'content_size',
			[
				'label' => __( 'Content Width', 'kipso-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 200,
				],
