...
<div class="<?php echo esc_attr($item_classes) ?>">
   <article id="post-<?php echo esc_attr(get_the_ID()); ?>" <?php post_class('course-block'); ?>>
      ...
      <div class="entry-content">
            ...
            <?php if(class_exists('Gavias_Themer_Comment')){ ?>
               ...
               <div class="course-reviews">
                  ...
                  <div class="average-ratings">
                     <span class="average"><?php echo esc_attr($average_ratings['rate']); ?></span>
                     <span class="rate-count"><?php echo esc_attr($average_ratings['count']); ?></span>
                  </div>
               </div>
            <?php } ?>   
         ...
         <div class="content-bottom">
            ...
            <i class="icon far fa-folder-open"></i>
               <?php echo ( esc_html($lesson_count) . ' ' . esc_html__( 'Lectures', 'kipso' ) ); ?>
            </div>
         ...
         <a href="<?php echo esc_url( get_permalink() ) ?>" rel="bookmark"><?php echo esc_html__('Ver curso', 'kipso') ?></a>
         </div>
      </div>
   </article>   
</div>
