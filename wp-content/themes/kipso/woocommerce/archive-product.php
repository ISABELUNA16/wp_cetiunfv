...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
  ...
  $sidebar_layout_config = kipso_get_option('woo_sidebar_config', '');
  $left_sidebar = kipso_get_option('woo_left_sidebar', '');
  $right_sidebar = kipso_get_option('woo_right_sidebar', '');
              ...
              <?php woocommerce_product_subcategories(); ?>  
                  ...
                  <div class="shop-loop-container">
                    <div class="gvawooaf-before-products layout-<?php echo esc_attr($woo_display) ?>">
                      ...
                      <?php do_action('kipso_woocommerce_active_filter' );  ?>
