...
class GVAElement_Icon_Box_Classic extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Icon Box Classic', 'kipso-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'position',
			[
				'label' => __( 'Position', 'kipso-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'top-center' 		=> __( 'Top Center', 'kipso-themer' ),
					'top-left' 			=> __( 'Top Left', 'kipso-themer' ),
					'top-right' 		=> __( 'Top Right', 'kipso-themer' ),
					'right' 				=> __( 'Right', 'kipso-themer' ),
					'left' 				=> __( 'Left', 'kipso-themer' ),
				],
				'default' => 'top-center',
				'condition' => [
					'icon!' => '',
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => __( 'Hover Animation', 'kipso-themer' ),
		...
		$this->add_responsive_control(
			'icon_size_image',
			[
				'label' => __( 'Image Icon Size', 'kipso-themer' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 50,
		...
		$this->add_control(
			'border_width',
			[
				'label' => __( 'Border Width', 'kipso-themer' ),
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Vertical Alignment', 'kipso-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'top' => __( 'Top', 'kipso-themer' ),
					'middle' => __( 'Middle', 'kipso-themer' ),
					'bottom' => __( 'Bottom', 'kipso-themer' ),
				],
				'default' => 'top',
