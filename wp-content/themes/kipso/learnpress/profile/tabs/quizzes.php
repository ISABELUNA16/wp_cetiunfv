...
<div class="learn-press-subtab-content">
    <h3 class="profile-heading"><?php echo esc_html__( 'My Quizzes', 'kipso' ); ?></h3>
	...
	<?php if ( $query['items'] ) { ?>
        <table class="lp-list-table profile-list-quizzes profile-list-table">
            <thead>
            <tr>
                <th class="column-course"><?php echo esc_html__( 'Course', 'kipso' ); ?></th>
                <th class="column-quiz"><?php echo esc_html__( 'Quiz', 'kipso' ); ?></th>
                <th class="column-date"><?php echo esc_html__( 'Date', 'kipso' ); ?></th>
                <th class="column-status"><?php echo esc_html__( 'Progress', 'kipso' ); ?></th>
                <th class="column-time-interval"><?php echo esc_html__( 'Interval', 'kipso' ); ?></th>
            </tr>
            </thead>
            <tbody>
	...
	<?php } else { ?>
		<?php learn_press_display_message( esc_html__( 'No quizzes!', 'kipso' ) ); ?>
	<?php } ?>
</div>
