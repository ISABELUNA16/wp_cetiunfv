...
<ul class="quiz-intro">
    <li>
        <label><?php echo esc_html__( 'Attempts allowed', 'kipso' ); ?></label>
        <span><?php echo ( null == $count || 0 > $count ) ? esc_html__( 'Unlimited', 'kipso' ) : ( $count ? $count : esc_html__( 'No', 'kipso' ) ); ?></span>
    </li>
    <li>
        <label><?php echo esc_html__( 'Duration', 'kipso' ); ?></label>
        <span><?php echo esc_html($quiz->get_duration_html()); ?></span>
    </li>
    <li>
        <label><?php echo esc_html__( 'Passing grade', 'kipso' ); ?></label>
