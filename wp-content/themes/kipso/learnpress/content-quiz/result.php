...
<div class="quiz-result <?php echo esc_attr( $result['grade'] ); ?>">
    ...
    <h3><?php echo esc_html__( 'Your Result', 'kipso' ); ?></h3>
    ...
    <div class="result-grade">
        ...
        <p class="result-message"><?php echo sprintf( esc_html__( 'Your grade is %s', 'kipso' ), $result['grade'] == '' ? esc_html__( 'Ungraded', 'kipso' ) : $result['grade_text'] ); ?> </p>
    </div>
