...
class GVAElement_Navigation_Menu extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Navigation Menu', 'kipso-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'sub_menu_min_width',
			[
				'label' => __( 'Submenu Min Width (px)', 'kipso-themer' ),
		...
		$this->add_control(
			'sub_menu_max_width',
			[
				'label' => __( 'Submenu Max Width (px)', 'kipso-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 500,
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'kipso-themer' ),
      ...
      $this->end_controls_tabs();
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sub Menu', 'kipso-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
      ...
      $this->add_control(
         ...
         [
            'label'     => __('Link Color', 'kipso-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
