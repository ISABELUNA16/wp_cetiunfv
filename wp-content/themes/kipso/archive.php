 ...
 */
	...
	$sidebar_layout_config = kipso_get_option('archive_post_sidebar', ''); 
  $left_sidebar = kipso_get_option('archive_post_left_sidebar', '');  
  $right_sidebar = kipso_get_option('archive_post_right_sidebar', ''); 
