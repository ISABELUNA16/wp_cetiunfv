...
function kipso_course_settings_meta_box_args($args){
  $args['fields'][] = array(
    'name'   => esc_html__('Skill level', 'kipso'),
    'id'    => "_course_skill_level",
    'type' => 'select',
    'options' => array(
      'principiante'      => esc_html__('Principiante', 'kipso'),
      'intermedio'  => esc_html__('Intermedio', 'kipso'),
      'avanzado'      => esc_html__('Avanzado', 'kipso'),
    ),
  );
  $args['fields'][] = array(
 ...
 add_filter( 'learn_press_course_settings_meta_box_args', 'kipso_course_settings_meta_box_args' , 99 );
