 ...
 */
   ...
   $sidebar_layout_config = kipso_get_option('archive_portfolio_sidebar', 'right-sidebar'); 
   $left_sidebar = kipso_get_option('archive_portfolio_left_sidebar', 'portfolio_sidebar');
   $right_sidebar = kipso_get_option('archive_portfolio_right_sidebar', 'portfolio_sidebar');
   ...
   $columns_lg = kipso_get_option('portfolio_columns_lg', '4');
   $columns_md = kipso_get_option('portfolio_columns_md', '3');
   $columns_sm = kipso_get_option('portfolio_columns_sm', '2');
   $columns_xs = kipso_get_option('portfolio_columns_xs', '1');
