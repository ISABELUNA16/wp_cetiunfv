 ...
 */
   ...
   $sidebar_layout_config = kipso_get_option('archive_service_sidebar', 'right-sidebar'); 
   $left_sidebar = kipso_get_option('archive_service_left_sidebar', 'service_sidebar');
   $right_sidebar = kipso_get_option('archive_service_right_sidebar', 'service_sidebar');
   ...
   $columns_lg = kipso_get_option('service_columns_lg', '4');
   $columns_md = kipso_get_option('service_columns_md', '3');
   $columns_sm = kipso_get_option('service_columns_sm', '2');
   $columns_xs = kipso_get_option('service_columns_xs', '1');
