 ...
 */
    ...
    $page_id = kipso_id();
    $default_sidebar_config = kipso_get_option('single_post_sidebar', 'right-sidebar'); 
    $default_left_sidebar = kipso_get_option('single_post_left_sidebar', 'default_sidebar');
    $default_right_sidebar = kipso_get_option('single_post_right_sidebar', 'default_sidebar');

    $sidebar_layout_config = get_post_meta($page_id, 'kipso_sidebar_config', true);
    $left_sidebar = get_post_meta($page_id, 'kipso_left_sidebar', true);
    $right_sidebar = get_post_meta($page_id, 'kipso_right_sidebar', true);
   ...
   <div class="container">  
    <div class="main-page-content row">
         ...
         <?php if($right_sidebar_config['active']): ?>
            ...
            // echo "<pre>";
            //esc_html( $categories[0]->slug);
            // var_dump($categories); 
            // echo "</pre>";

            if($categories[0]->slug == "cursos-modulares"){?>
