 ...
 */
    ...
    $default_sidebar_config = kipso_get_option('single_service_sidebar', ''); 
    $default_left_sidebar = kipso_get_option('single_service_left_sidebar', '');
    $default_right_sidebar = kipso_get_option('single_service_right_sidebar', '');
