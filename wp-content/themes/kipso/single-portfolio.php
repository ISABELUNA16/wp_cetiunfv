 ...
 */
    ...
    $default_sidebar_config = kipso_get_option('single_portfolio_sidebar', 'right-sidebar'); 
    $default_left_sidebar = kipso_get_option('single_portfolio_left_sidebar', 'blog_sidebar');
    $default_right_sidebar = kipso_get_option('single_portfolio_right_sidebar', 'blog_sidebar');
